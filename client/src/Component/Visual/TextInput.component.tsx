...
const Text_input_component = (text_input:Text_input_props) =>
{
    ...
    return (
        <>
            ...
            className={"text-black p-2 pl-6 pr-6 drop-shadow-lg rounded-md hover:scale-[1.02] transition-[250ms] bg-button-default dark:bg-button-dark-default dark:text-white"}></input>
